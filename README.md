...
```bash
NEXT_PUBLIC_WHATSAPP_NUMBER=522206392949
NEXT_PUBLIC_WHATSAPP_MESSAGE=Hola, quiero información sobre eventos y organización en Glocal Live.
```
...
```bash
RESEND_API_KEY=re_...
GLOCAL_LEADS_EMAIL=glocalive@hotmail.com
