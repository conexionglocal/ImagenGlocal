  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Conservación y derechos", paragraphs: ["Conservamos los datos solo durante el tiempo necesario para atender la solicitud y cumplir obligaciones aplicables. Puedes solicitar acceso, corrección o eliminación escribiendo a info@imagen-glocal.com."] },
